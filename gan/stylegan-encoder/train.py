...
if 1:
    ...
    # Dataset.
    # namazu:/home/yuanyuan/maskrcnn-benchmark/pytorch-CycleGAN-and-pix2pix/datasets/black2white_wkiva/all_upsampled
    
    # desc += '-cyclegan_black2white_wkiva_tfblk_20';     dataset = EasyDict(tfrecord_dir='/home/yuanyuan/maskrcnn-benchmark/pytorch-CycleGAN-and-pix2pix/datasets/black2white_wkiva/tfrecord_blk');              train.mirror_augment = True
    # desc += '-kiva_split_2000';     dataset = EasyDict(tfrecord_dir='/shared/yuanyuan/kiva_split_2000/tfrecord_blk');              train.mirror_augment = True
    # desc += '-kiva_gan_158881';     dataset = EasyDict(tfrecord_dir='/shared/yuanyuan/parallel/kiva_gan_upsampled_tfrecord');              train.mirror_augment = True
    desc += '-upsampled_highresol256768_b2';     dataset = EasyDict(tfrecord_dir='/shared/yuanyuan/parallel/kiva_gan_upsampled_highresol256768_tfrecord');              train.mirror_augment = True
    ...
    sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.007}
